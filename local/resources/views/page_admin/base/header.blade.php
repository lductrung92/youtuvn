        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown dropdown-user">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    <li><a href="administrator/user/profile"><i class="icon-user-plus"></i> Thông tin cá nhân</a></li>
                    ...
                    <li><a href="administrator/logout"><i class="icon-switch2"></i> Đăng xuất</a></li>
                </ul>
            </li>
        </ul>
    </div>
